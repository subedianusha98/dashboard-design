...
import {ArrowUpIcon , ArrowDownIcon , ArrowLeftIcon , ArrowRightIcon , TrashIcon , PlusIcon} from "lucide-react";
...
<div className="w-[203px] h-[50px] px-4 py-2 border-r border-b border-gray-200 justify-between items-center inline-flex">
    <div className="justify-start items-center gap-0.5 flex">
        <div className="text-slate-700 text-xs font-medium font-['Inter'] leading-none">Name</div>
